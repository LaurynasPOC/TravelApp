...
class CustomerController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $customer->save();
        return redirect()->route('customers.index')->with('status_success', 'New customer created!');
    }
    ...
    public function update(Request $request, Customer $customer){
        $customer->fill($request->all());
        $customer->save();
        return redirect()->route('customers.index')->with('status_success', 'Customer info updated!');
    }
